...
-- ===============================================
-- 6. INSERT PETS (Mascotas) - corregido
-- ===============================================
INSERT INTO pets (id, name, birth_date, type_id, owner_id, age) VALUES 
(1, 'Leo', '2000-09-07', 1, 1, 1),
(2, 'Bella', '2001-02-10', 2, 1, 1),   -- nueva mascota para dueño 1
(3, 'Basil', '2002-08-06', 6, 2, 2),
(4, 'Rosy', '2001-04-17', 2, 3, 3),
(5, 'Jewel', '2000-03-07', 2, 3, 3),
(6, 'Iggy', '2000-11-30', 3, 4, 8),
(7, 'George', '2000-01-20', 4, 5, 8),
(8, 'Samantha', '1995-09-04', 1, 6, 10),
(9, 'Max', '1995-09-04', 1, 6, 1),
(10, 'Lucky', '1999-08-06', 5, 7, 2),
(11, 'Mulligan', '1997-02-24', 2, 8, 2),
(12, 'Freddy', '2000-03-09', 5, 9, 4),
(13, 'Lucky', '2000-06-24', 2, 10, 3),
(14, 'Sly', '2002-06-08', 1, 10, 1);
